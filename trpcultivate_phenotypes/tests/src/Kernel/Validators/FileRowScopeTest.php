...
class FileRowScopeTest extends ChadoTestKernelBase {
  ...
  public function testDuplicateTraitsPluginValidator() {
    ...
    $unique_traits = $instance->getUniqueTraits();
    $this->assertArrayHasUniqueCombo('my trait', 'my method', 'my unit 2', $unique_traits, 'Failed to find expected key within the global $unique_traits array for combo #2.');
