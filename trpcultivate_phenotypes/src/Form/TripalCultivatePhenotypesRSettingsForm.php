...
class TripalCultivatePhenotypesRSettingsForm extends ConfigFormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $config->set($config_r . 'words', explode(',', $form_state->getValue('words')));
    $config->set($config_r . 'chars', explode(',', $form_state->getValue('chars')));
    $config->set($config_r . 'replace', explode(',', $form_state->getValue('replace')));
    $config->save();
