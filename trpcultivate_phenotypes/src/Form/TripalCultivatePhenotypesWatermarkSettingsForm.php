...
class TripalCultivatePhenotypesWatermarkSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['charts'] = [
      ...
      '#default_value' => (int) $config->get($config_watermark . 'charts'),
      '#required' => TRUE,
    ];
    ...
    $image = $config->get($config_watermark . 'image');
    ...
    $source_path = $config->get('trpcultivate.phenotypes.directory.watermark');
    $valid_ext = $config->get($config_watermark . 'file_ext');
